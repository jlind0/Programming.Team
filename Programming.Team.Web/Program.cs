...
Console.WriteLine("read: ", builder.Configuration["Stripe:APIKey"]);
...
builder.Services.AddTransient<AddExpVM>();
...
builder.Services.AddTransient<AddExpSkillVM>();
