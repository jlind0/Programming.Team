...
builder.Services.AddTransientAndInit<PositionsViewModel>();
...
builder.Services.AddTransientAndInit<PositionSkillsViewModel>();
...
builder.Services.AddTransientAndInit<EducationsViewModel>();
builder.Services.AddTransient<SearchSelectPositionViewModel>();
builder.Services.AddTransient<AddRecommendationViewModel>();
builder.Services.AddTransientAndInit<RecommendationsViewModel>();
...
builder.Services.AddTransientAndInit<CertificatesViewModel>();
builder.Services.AddTransient<AddPublicationViewModel>();
builder.Services.AddTransientAndInit<PublicationsViewModel>();
builder.Services.AddTransient<AddDocumentTypeViewModel>();
builder.Services.AddTransientAndInit<DocumentTypesViewModel>();
builder.Services.AddTransient<AddDocumentTemplateViewModel>();
builder.Services.AddTransientAndInit<DocumentTemplatesViewModel>();
...
builder.Services.AddTransientAndInit<PackagesViewModel>();
builder.Services.AddTransient<AddSectionTemplateViewModel>();
builder.Services.AddTransientAndInit<SectionTemplatesViewModel>();
